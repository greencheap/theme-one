...
<html class="<?= $params['html_class'] ?>" lang="<?= $intl->getLocaleTag() ?>">
    <head>
        ...
        <?= $view->render('head') ?>
        <?php $view->style('theme', 'theme:dist/css/uikit.theme-one.min.css') ?>
                    ...
                    <nav uk-navbar>
                        ...
                        <div class="uk-navbar-left">
                            <a class="uk-navbar-item uk-logo" href="<?= $view->url()->get() ?>">
                                <?php if ($params['logo']) : ?>
                                    <img width="250px" src="<?= $this->escape($params['logo']) ?>" alt="">
                                    <img width="250px" class="uk-logo-inverse" src="<?= ($params['logo_contrast']) ? $this->escape($params['logo_contrast']) : $this->escape($params['logo']) ?>" alt="">
                                <?php else : ?>
                                    <?= $params['title'] ?>
                                <?php endif ?>
                            </a>
